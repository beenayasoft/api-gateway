...
SERVICES = {
    ...
    "crm": {
        ...
        "health": "/health/",
        "routes": ["/api/tiers/", "/api/opportunites/"]
    },
    "documents": {
        "url": config("DOCUMENT_SERVICE_URL", default="http://localhost:8004"),
        "health": "/health/",
        "routes": ["/api/quotes/", "/api/invoices/", "/api/devis/", "/api/factures/"]
    }
}
...
LEGACY_ROUTE_MAPPING = {
    ...
    "/api/tiers/{id}/restaurer/": ("crm", "/api/tiers/{id}/restaurer/"),
    ...
    "/api/opportunites/{id}/update_stage/": ("crm", "/api/opportunites/{id}/update_stage/"),
    "/api/opportunites/{id}/mark_won/": ("crm", "/api/opportunites/{id}/mark_won/"),
    "/api/opportunites/{id}/mark_lost/": ("crm", "/api/opportunites/{id}/mark_lost/"),
    ...
    "/tiers/{id}/restaurer/": ("crm", "/api/tiers/{id}/restaurer/"),
    "/tiers/": ("crm", "/api/tiers/"),
    ...
    "/opportunites/": ("crm", "/api/opportunites/"),
    "/opportunites/{id}/": ("crm", "/api/opportunites/{id}/"),
    "/opportunites/stats/": ("crm", "/api/opportunites/stats/"),
    "/opportunites/kanban/": ("crm", "/api/opportunites/kanban/"),
    "/opportunites/{id}/update_stage/": ("crm", "/api/opportunites/{id}/update_stage/"),
    "/opportunites/{id}/mark_won/": ("crm", "/api/opportunites/{id}/mark_won/"),
    "/opportunites/{id}/mark_lost/": ("crm", "/api/opportunites/{id}/mark_lost/"),
